package com.amazonaws.assignment3;
/*
 ...
 * (C:\\Users\\jt991\\.aws\\credentials) where the sample code will load the credentials from.
 * <p>
...
public class S3TransferProgressSample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            throw new AmazonClientException(
                    ...
                    "location (C:\\Users\\jt991\\.aws\\credentials), and is in valid format.",
                    e);
        }
        ...
        bucketName = "assignment3bucket-" + StringUtils.lowerCase(accessKeyId);
    ...
    class ButtonListener implements ActionListener {
        public void actionPerformed(ActionEvent ae) {
            ...
            System.out.println("Uploading New File To Bucket...\n");
            ...
            System.out.println("Listing Contens of Bucket:\n");
            System.out.println(tx.getAmazonS3Client().listObjects(bucketName).toString());
            System.out.println();
            
            System.out.println("Deleting File...\n");
            tx.getAmazonS3Client().deleteObject(bucketName, fileToUpload.getName());
            
            System.out.println("Listing Contens of Bucket:\n");
            tx.getAmazonS3Client().listObjects(bucketName);
            System.out.println();
            
            System.out.println("Deleting Bucket...\n");
            deleteAmazonS3Bucket();
        }
    }
    ...
    private void deleteAmazonS3Bucket() {
        try {
            if (tx.getAmazonS3Client().doesBucketExistV2(bucketName) == true) {
                tx.getAmazonS3Client().deleteBucket(bucketName);
            ...
            JOptionPane.showMessageDialog(frame, "Unable to delete Amazon S3 bucket: " + ace.getMessage(),
                    "Error Deleting Bucket", JOptionPane.ERROR_MESSAGE);
        }
    }
